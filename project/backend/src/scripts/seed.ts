...
async function seed() {
    try {
        ...
        const diligenceRepository = data_source_1.AppDataSource.getRepository(Diligence_1.Diligence);
        const attachmentRepository = data_source_1.AppDataSource.getRepository(Attachment_1.Attachment);
        const paymentRepository = data_source_1.AppDataSource.getRepository(Payment_1.Payment);
        const statusHistoryRepository = data_source_1.AppDataSource.getRepository(StatusHistory_1.StatusHistory);
